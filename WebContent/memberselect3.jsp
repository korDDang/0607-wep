...
ResultSet rs=null;
try{
	String sql="select e.custno,e.custname,e.grade,sum(m.price)from member0607 e, money0607 m where e.custno=m.custno group by e.custno,e.custname,e.grade order by custno";
